...
for i = 1 : length(subject)
	for j = 1 : length(task)
		...
		EEG = pop_loadset('filename', num2str(filename),'filepath','D:\\DATA_ARRANGED\\EEG_chanlocs\\');
		...
		EEG = pop_saveset( EEG, 'filename', num2str(savename),'filepath','D:\\DATA_ARRANGED\\EEG_trimmed\\');
