%EEG pseudo epoching continuous data (keeping -+5 sec around events 'S7'
%and 'S8'
...
for i = 1 : length(subject)
	for j = 1 : length(task)
		...
		EEG = pop_loadset('filename', num2str(filename),'filepath','D:\\DATA_ARRANGED\\EEG_rereferenced\\');
		[ALLEEG, EEG, CURRENTSET] = eeg_store( ALLEEG, EEG, 0 );
		EEG = pop_rmdat( EEG, {'S  7','S  8'},[-5 5] ,0);
		[ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, 1,'overwrite','on','gui','off'); 
        EEG = pop_saveset( EEG, 'filename', num2str(savename),'filepath','D:\\DATA_ARRANGED\\EEG_epoched\\');
