...
for i = 1 : length(subject)
    for j = 1 : length(task)
		...
		filename = strcat( subject{i}, lab, task{j}, ECGext, trimext, filtext, setext);
		setname = strcat( subject{i}, lab, task{j}, ECGext, trimext, filtext);
		savename = strcat( subject{i}, lab, task{j}, ECGext, trimext, filtext, detext, setext);

		EEG = pop_loadset('filename', num2str(filename),'filepath','C:\\DATA_ARRANGED\\ECG_filtered\\');
